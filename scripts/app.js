...
const mascaraCelular 		= "(00) 0 0000-0000";
const mascaraCPF 			= "000.000.000-00";
const mascaraDataNascimento	= "00/00/0000";
...
function validateForm(obj){
	...
	for(var i = 0; i < obj.length; i++){
		if(obj[i].validation(obj[i].var.val())){
			domCorreto.push(obj[i].var);
		}
		else{
			domErrado.push(obj[i].var);
		}
	}
	return {
		erro: domErrado,
...
var formularioValidacao	= [
	{
		var: domNomeDependente,
		validation: validarNaoVazio
	},
	{
		var: domCPFDependente,
		validation: validarCPF
	},
	{
		var: domNascimentoDependente,
		validation: validarData
	},
	{
		var: domTelefoneDependente,
		validation: validarTelefone
	},
	{
		var: domCelularDependente,
		validation: validarCelular
	},
	{
		var: domEnderecoDependente,
		validation: validarNaoVazio
	},
	{
		var: domNomeResponsavel,
		validation: validarNaoVazio
	},
	{
		var: domCPFResponsavel,
		validation: validarCPF
	},
	{
		var: domTelefoneResponsavel,
		validation: validarTelefone
	},
	{
		var: domCelularResponsavel,
		validation: validarCelular
	},
	{
		var: domEnderecoResponsavel,
		validation: validarNaoVazio
	}
];
